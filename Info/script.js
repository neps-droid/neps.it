...
var sts = [
	/*[0]*/
	'Ciao...sono qui per aiutarti a ottenere il tuo futuro sito web._^',
	/*[1]*/
	...
	'',
	/*[5]*/
	'Ciò di cui abbiamo effettivamente bisogno è che tu ci dica cosa vorresti nel sito web._^',
	/*[6]*/
	'Esprimi i tuoi più remoti desideri>. In questo modo capiremo meglio le tue esigenze.',
	/*[7]*/
	'',
	/*[8]*/
...
_your_name_react = function() {
	if (your_name.value != '' && si == 1) {
		...
		sts[2] = 'Molto bene, di cosa si occupa ' + yourname +'?>'
		si = 2;
		ii = 2;
...
_email_address_react = function() {
	if (email_address.value != '' && si == 2) {
		...
		sts[3] = 'Perfetto, ' + yourname + '. Hai già un sito web?_ Se si ti contatteremo noi!>'
		si = 3;
		ii = 3;
...
_send_pitch = function() {
	if (type.innerHTML.length == 0) {
		...
		sts[7] = 'Molto bene, ' + yourname + '. Abbiamo tutto quello che ci serve. Possiamo proseguire.^';
		si = 7;
		ii = 7;
		_update_step();
		_type();
